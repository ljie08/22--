...
//    [statusbarView setBackgroundColor:COLOR_002];
    ...
    self.navigationView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 20, SCREEN_WIDTH, 44)];
...
- (void)setNavigationTitle:(NSString *)navigationTitle{
    ...
    if (!self.labelTitle) {
        ...
        self.labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, labelSize.width, 28)];
        ...
        //文字基本设置
        _labelTitle.textColor = COLOR_002;
